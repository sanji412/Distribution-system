...
public class GatewayJwtTokenService {
    ...
    public GatewayUserContext parseToken(String token) {
    ...
    public String generateToken(GatewayUserContext userContext, long expireMinutes) {
        ...
        payload.put("sub", userContext.userId());
        payload.put("username", userContext.username());
        payload.put("role", userContext.role());
