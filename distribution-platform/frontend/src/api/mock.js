...
export const governanceMock = {
  ...
  routes: [
    ...
    'spring.cloud.gateway.routes[2].uri=lb://order-center',
...
export const monitorMock = {
  cards: [
    { title: 'SPRINGBOOT 版本', value: '3.2.5', tone: 'primary' },
    { title: 'SPRINGCLOUD ALIBABA', value: '2022.0.0.0', tone: 'success' },
  ...
  rows: [
    ['SpringBoot版本', '3.2.5', '基于 Spring Framework 6.1'],
    ['SpringCloud Alibaba版本', '2022.0.0.0', 'Nacos + Gateway + OpenFeign + Sentinel + Seata'],
    ['JDK版本', '21', 'LTS长期支持版本'],
